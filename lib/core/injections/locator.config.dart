...
import '../../services/network/network_info.dart' as _i13;
import '../../services/network/network_info_impl.dart' as _i14;
import '../../services/network/network_service.dart' as _i18;
import '../../services/network/network_service_impl.dart' as _i19;
import '../models/usecases/base_64_encode.dart' as _i17;
import '../models/usecases/usecase.dart' as _i15;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i10.Isar>(() => registerModule.isar);
    gh.lazySingleton<_i11.JwtService>(() => _i12.JwtServiceImpl());
    gh.lazySingleton<_i13.NetworkInfo>(
        () => _i14.NetworkInfoImpl(connectivity: gh<_i8.Connectivity>()));
    await gh.lazySingletonAsync<_i6.SharedPreferences>(
      () => registerModule.sharedPreferences,
      preResolve: true,
    );
    gh.lazySingleton<_i15.UseCase<String, _i16.Uint8List>>(
        () => const _i17.Base64Encode());
    gh.lazySingleton<_i18.NetworkService>(() => _i19.NetworkServiceImpl(
          gh<_i9.Dio>(),
    ...
    gh.lazySingleton<_i20.HomeRepository>(() => _i21.HomeRepositoryImpl(
          gh<_i18.NetworkService>(),
          gh<_i3.LocaleResourcesService>(),
          gh<_i10.Isar>(),
        ));
    return this;
  }
